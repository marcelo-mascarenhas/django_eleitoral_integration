"""
Django settings for integrated project.
...
SECRET_KEY = 'django-insecure-iz+&pwai7j+!ul&$#9faq-(s0^#zanekwvird_(kq@f)v_pffb'
...
WSGI_APPLICATION = 'integrated.wsgi.application'
